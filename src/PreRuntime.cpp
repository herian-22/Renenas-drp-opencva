...
uint8_t PreRuntime::Pre(s_preproc_param_t* param, void** out_ptr, uint32_t* out_size)
{
    ...
    {
        /* === PERBAIKAN UNTUK DRP-AI TIMEOUT === */
        /* 'if' check berikut ini dikomentari. */
        /* Ini memaksa ioctl(DRPAI_SET_ADRCONV) untuk berjalan di SETIAP frame, */
        /* yang mencegah hardware DRP-AI masuk ke state hang/timeout. */
